...
public class Array {
	static java.lang.String romanNumeral;
    static int decimalNum;
    public static void main(String args[]) {
            Array rmtoD = new Array();
    ...
    public static void printRoman (java.lang.String romanNumeral2){
            System.out.println ("The equivalent of the Roman numeral "+romanNumeral2+" is "+decimalNum);
    }
